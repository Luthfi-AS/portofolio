...
function Navbar() {
  ...
  return (
    <nav className="sticky z-20 top-0 flex items-center p-8 text-gray-text bg-gray-box gap-8 font-ibm-plex-mono">
      <div id="navigation-bar " className="mr-auto flex gap-12 ml-20">
        {menus.map((menu) => (
          <a
            key={menu.id}
            href={`#${menu.id}`} // Mengarahkan ke ID seperti #home, #about, dll
      ...
      <div id="image-bar" className="flex ml-auto gap-6 ">
        {imgs.map((img) => (
          <a
            ...
            className="transition-transform hover:scale-110" // Tambahan agar ada efek saat di-hover
          >
            <img
              src={img.src}
              alt={img.alt}
              className="w-6 h-6 object-contain" // Pastikan ukuran ikon konsisten
            />
          </a>
        ))}
      </div>
...
function Footer() {
  return (
    <footer className="flex relative items-center p-6 justify-center">
      <p id="copyright">
        © 2025 Muhammad Luhtfi Aziz Sunarya. All rights reserved.
      </p>
    </footer>
  );
}
    ...
    >
      <div id="profile-text-area" className=" grid gap-7 ml-7 w-1/2">
        ...
        <h4 className="font-ibm-plex-mono text-gray-text text-justify">
          Informatics Engineering student at Universitas Padjadjaran with strong
          interest in data science, machine learning, and software engineering.
          Experienced in organizational leadership and large-scale project
          management with proven ability to lead teams, design strategies, and
          deliver high-impact programs. Seeking opportunities to apply
...
function AboutMe() {
  return (
    ...
    >
      <div id="about-text-area" className="grid gap-6 size-1/3">
        ...
        <p className="text-justify indent-8 font-lato text-gray-text">
          As an Informatics Engineering student, I have developed a balance of
          technical competencies and essential soft skills that enable me to
          solve problems effectively, adapt to new technologies, and collaborate
        ...
        <div id="speciality-row-1" className="flex gap-15 mt-10">
          <section id="data-analysis" className="grid">
            ...
            <section className="grid gap-10 shadow-box bg-gray-box rounded-md">
              ...
              <p className="font-ibm-plex-mono text-gray-text text-justify indent-8 ml-5 mr-5 mb-10">
                I have expertise in data analysis, including data processing,
                creating visualizations, and performing interpretation to
          ...
          <section id="leadership" className="grid ">
            ...
            <section className=" grid bg-gray-box shadow-box rounded-md gap-10">
              ...
              <p className="font-ibm-plex-mono text-gray-text text-justify indent-8 ml-5 mr-5 mb-10">
                Through my experience, I have strengthened my leadership skills,
                particularly in team collaboration, communication, and guiding
        ...
        <div id="speciality-row-2" className="flex gap-15">
          <section id="web-development" className="grid">
            ...
            <section className="grid gap-10 shadow-box bg-gray-box rounded-md w-full">
              ...
              <p className="font-ibm-plex-mono text-gray-text text-justify indent-8 ml-5 mr-5 mb-10">
                I have hands-on experience developing full-stack website app,
                from crafting designs to implementing front-end, back-end, and
          ...
          <section id="project-management" className="grid">
            ...
            <section className=" grid bg-gray-box shadow-box rounded-md gap-10">
              ...
              <p className="font-ibm-plex-mono text-gray-text text-justify indent-8 ml-5 mr-5 mb-10 ">
                I have project management experience involving task planning,
                timeline management, and coordination within teams to ensure
  ...
  return (
    ...
    >
      ...
      <p className="text-justify indent-8 font-lato text-gray-text w-1/3">
        ...
        experience in applying technical skills, problem-solving, and practical
      ...
      <div id="project-cards1" className="flex gap-6 ml-20 mr-20 mt-20">
        <p className="font-ibm-plex-mono text-gray-text w-1/2  text-justify">
          ...
          competitive performance in a national-level data science competition.
        </p>
        <a
      ...
      <div id="project-cards2" className="flex gap-6 ml-20 mr-20">
        ...
        <p className="text-gray-text font-ibm-plex-mono w-1/2">
          ...
          Indonesian product reviews to identify sentiment polarity and uncover
          dominant discussion topics, successfully passing internal university
          selection for GEMASTIK.
        </p>
      </div>

      <div id="project-cards3" className="flex gap-6 ml-20 mr-20">
        <p className="font-ibm-plex-mono text-gray-text w-1/2  text-justify">
          Managed a large-scale executive board of 115 members at HIMATIF Unpad,
          fostering a collaborative environment that drove organizational
          excellence. This strategic coordination resulted in the association
          receiving various awards and nominations at the faculty level.
        </p>
      ...
      <div id="project-cards4" className="flex gap-6 ml-20 mr-20">
        ...
        <p className="text-gray-text font-ibm-plex-mono w-1/2">
          ...
          enables users to browse products, add items to the cart, and complete
          purchases. In this project, I worked as a full-stack developer,
          developing both the frontend and backend using the CodeIgniter
          framework, including database integration and core transaction
          features.
        </p>
      </div>
...
function GetInTouch() {
  ...
  return (
    <div id="contact">
      ...
      <div
        id="form-area"
        className="grid gap-20 mt-20 place-items-center w-full"
      >
        <form action={formAction}>
          ...
          <div className="mt-6 flex gap-6">
            ...
            <textarea
              placeholder="Message"
              name="message"
              className="font-ibm-plex-mono text-white bg-gray-form rounded-md w-xl h-30 indent-6 pt-2"
            />
          </div>
          <div className="w-full ml-245 place-items-center">
            <button
              type="submit"
              disabled={pending}
              className={`border-2 border-gray-box shadow-box rounded-md font-bold mt-10 w-1/6 
                  ${
                    pending
